...
const Values = () => {
    return (
        <div className="relative h-1/2 w-screen bg-green-700 bg-opacity-78 flex flex-col justify-center items-center space-x-8 mb-6 pt-10 pb-14">
            <h1 className='text-6xl font-extrabold my-8'>
                OUR GOALS
            </h1>
