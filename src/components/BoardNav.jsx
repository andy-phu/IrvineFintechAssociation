...
const BoardNav = () => {
    ...
    const style = {color:"black", opacity:"90%"}
    ...
    return (
        <div className='absolute flex justify-between w-full z-10 text-black'>
            ...
            <div className='flex items-center'>
                <Link to="/home" className=' text-black text-decoration-none text-lg font-bold px-6 hover:opacity-70 sm-hidden'>HOME</Link>

                {/* Meet Us! Dropdown */}
                <div className='relative group'>
                    <button onClick={toggleDropdown} className='text-black text-decoration-none border-none text-lg font-bold px-6 hover:opacity-70 sm-hidden'>
                        MEET US!
                    </button>
                    {showDropdown && (
                ...
                <Link to="/events" className='text-black text-decoration-none text-lg font-bold px-6 hover:opacity-70 sm-hidden'>EVENTS</Link>
                <Link to="/gallery" className='text-black text-decoration-none text-lg font-bold px-6 hover:opacity-70 sm-hidden'>GALLERY</Link>
                <Link to="/joinus" className='text-black text-decoration-none text-lg font-bold pl-6 pr-8 hover:opacity-70 sm-hidden'>JOIN US!</Link>
            </div>
